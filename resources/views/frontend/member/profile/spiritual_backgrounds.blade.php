    ...
    <div class="card-body">
      <form action="{{ route('spiritual_backgrounds.update', $member->id) }}" method="POST">
          ...
          <div class="form-group row">
              ...
              <div class="col-md-6">
                  <label for="community">{{translate('Community')}}</label> <span class="text-danger">*</span>
                  <select class="form-control aiz-selectpicker" name="community" id="community" data-live-search="true" required>
                        <option value="">{{translate('Select One')}}</option>
          ...
          <div class="form-group row">
              <div class="col-md-6">
                  <label for="block">{{translate('Block')}}</label> <span class="text-danger">*</span>
              ...
              <div class="col-md-6">
                <label for="Patti">{{translate('Khat/Patti')}}</label> <span class="text-danger">*</span>
                <select class="form-control aiz-selectpicker" name="patti" id="patti" data-live-search="true" required >
                  <option value="">
                      {{translate('Select One')}}
                  </option>
                  @php
          ...
          <div class="form-group row">
              <div class="col-md-6">
                  <label for="Your Gaon">{{translate('Your Gaon')}}</label> <span class="text-danger">*</span>
                  <input required type="text" name="gaon" value="{{!empty($member->spiritual_backgrounds->gaon) ? $member->spiritual_backgrounds->gaon : "" }}" class="form-control" placeholder="{{translate('gaon')}}">
                  @error('gaon')
                      <small class="form-text text-danger">{{ $message }}</small>
                  @enderror
              </div>
              <div class="col-md-6">
                <label for="Khandan/Parivaar">{{translate('Khandan/Parivaar Name')}}</label> <span class="text-danger">*</span>
                <input required type="text" name="khandan" value="{{!empty($member->spiritual_backgrounds->khandan) ? $member->spiritual_backgrounds->khandan : "" }}" class="form-control" placeholder="{{translate('khandan')}}">
                @error('khandan')
                    <small class="form-text text-danger">{{ $message }}</small>
                @enderror
            </div>
